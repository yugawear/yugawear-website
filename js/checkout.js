...
const WHATSAPP_NUMBER = "917306520432";
// Exexl sheet google API
const ORDER_API =
...
function saveCustomerDetails(){
    ...
    const customer = {
        ...
        pin: document.getElementById("customerPin").value
...
if(!city){
    ...
    showError("customerCity","cityError");
...
if(!state){
    ...
    showError("customerState","stateError");
...
if(!pin){
    ...
    showError("customerPin","pinError");
